...
// Stub exports required by some game modules (NWindow.dll etc.)
extern "C" int   WINAPI D3DPERF_BeginEvent(DWORD col, LPCWSTR name) { (void)col; (void)name; return 0; }
extern "C" int   WINAPI D3DPERF_EndEvent() { return 0; }
extern "C" void  WINAPI D3DPERF_SetMarker(DWORD col, LPCWSTR name) { (void)col; (void)name; }
extern "C" void  WINAPI D3DPERF_SetRegion(DWORD col, LPCWSTR name) { (void)col; (void)name; }
extern "C" BOOL  WINAPI D3DPERF_QueryRepeatFrame() { return FALSE; }
extern "C" void  WINAPI D3DPERF_SetOptions(DWORD opt) { (void)opt; }
